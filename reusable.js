(function(global){
    ...
    ================================================================================================*/
    (function(expressionsObj){

        /* angular-expression - parse.js
        ================================================================================================*/
        "use strict";
         ...
         * @constructor
         */
        let Parser = function (lexer, $filter, options) {
          this.lexer = lexer;
          this.$filter = $filter;
          this.options = options;
        };
        ...
        /* angular-expression - main.js
        ================================================================================================*/

        const filters = {};
        const lexer = new Lexer({});
        const parser = new Parser(lexer, getFilter);
        ...
        expressionsObj.Lexer = Lexer;
        expressionsObj.Parser = Parser;
        expressionsObj.compile = compile;
